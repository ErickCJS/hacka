...
import controladores.controlador_denuncia_carro as controlador_carro
...
@denuncias_bp.route('/registrar/carro', methods=['POST'])
def registrar_denuncia_carro():
    """Registra una nueva denuncia"""
    try:
        # Extraer datos del form-data
        id_usuario = request.form.get('id_usuario')
        ...
        descripcion_carro = request.form.get('descripcion_carro')
        ...
        # Registrar denuncia de vehículo si corresponde
        if placa and tipo_vehiculo:
            from datetime import datetime
            fecha_registro = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
            estado_carro = "pendiente"

            controlador_carro.crear_denuncia_carro(
                id_incidencia=id_incidencia,
                placa=placa,
                color=color,
                tipo_vehiculo=tipo_vehiculo,
                descripcion=descripcion_carro,
